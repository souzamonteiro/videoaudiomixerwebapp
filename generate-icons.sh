...
# Script to generate all the icons for the Video Audio Mixer PWA

echo "Generating icons for the Video Audio  PWA..."
...
cat > www/manifest.json << EOF
{
  ...
  "short_name": "VideoAudioMixer",
  "start_url": "./index.html",
  "display": "standalone",
  "theme_color": "#3498db",
  "background_color": "#f5f7fa",
  "description": "A web-based video and audio mixer application.",
  "icons": [
    {
